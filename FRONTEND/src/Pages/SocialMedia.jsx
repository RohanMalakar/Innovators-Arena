...
function SocialMedia() {
    return (
        <div className='h-[100%] max-w-8xl mx-auto p-5 bg-white  rounded-md shadow-md'>
            <h2 className='text-4xl font-bold text-red-500 {/*shadow-lg shadow-black*/}  mb-8  text-center'>Let's Connect</h2>
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6'>
                {appsData.map((app) => (
                    <div key={app.id} className='bg-gray-900 shadow-lg shadow-black rounded-lg hover:bg-gray-800 hover:scale-105 hover:translate-y-5 transition duration-500 ease-in-out p-6 flex flex-col items-center'>
                        ...
                        <button className='bg-red-500 text-black rounded-full  px-4 py-2 flex items-center hover:bg-white hover:scale-125 hover:shadow-white hover:opacity-30 transition duration-500 ease-in-out'>
            ...
            <div className='flex gap-48 pt-10 items-center '>
                <div className=" text-9xl opacity-40  text-red-900  font-extrabold ">Innovators-Arena</div>
                {/* <img
                    src={gif7}
